...
std::vector<unsigned char> BinanceAuth::getSeedFromPem(const std::string& pemPath) {
...
std::string BinanceAuth::signPayload(const std::string& payload, const std::vector<unsigned char>& seed) {
